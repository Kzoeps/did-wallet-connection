...
function RouteComponent() {
  ...
  const handleCreateOrVerifyPasskey = useCallback(
    async (type: "login" | "signup") => {
    ...
    [loginWithPasskey, signupWithPasskey, fetchAttestation, isReady, session]
  );
                ...
                <div className="grid w-full grid-cols-1 gap-4">
                    ...
                    {attestationLoading ? (
                      ...
                      <>
                        ...
                        <div className="mt-3">
                          <button
                            onClick={() =>
                              handleCreateOrVerifyPasskey("signup")
                            }
                            disabled={
                  ...
                  <div className="rounded-xl border border-gray-200 bg-white/70 p-4 text-left shadow-sm">
                    ...
                    {privyWalletAddress ? (
                      ...
                      <p className="text-sm text-gray-500 mt-2">
                        Sign in with Privy or complete passkey verification to
                        populate.
                      </p>
                    )}
                  </div>
